...
# f_ <- "./queries/test_si_tabl_covid.sql"
f_ <- "./queries/test_si_tabl_covid_sicd.sql"
# %>% 
#   .[14:14]
...
```{r}
f_out <- c("./covid_exam_res_",get_ts(), ".rds") %>% 
  str_c(., collapse = "")
f_out
res %>% 
